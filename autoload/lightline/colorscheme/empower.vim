...
let s:p.normal.right = [ [ '#303540', '#fabd2f', s:term_black, s:term_green, 'bold' ], [ '#abb2bf', '#3e4452', s:term_white, s:term_grey ], [ '#98c379', '#303540', s:term_green, s:term_black ] ]
let s:p.inactive.right = [ [ '#303540', '#729fcf', s:term_black, s:term_blue, 'bold'], [ '#abb2bf', '#3e4452', s:term_white, s:term_grey ] ]
let s:p.inactive.left = [ [ '#729fcf', '#303540', s:term_black, s:term_blue] ]
let s:p.insert.left = [ [ '#303540', '#729fcf', s:term_black, s:term_blue, 'bold' ], [ '#729fcf', '#303540', s:term_blue, s:term_black ] ]
let s:p.insert.right = [ [ '#303540', '#fabd2f', s:term_black, s:term_blue, 'bold' ], [ '#ABB2BF', '#3E4452', s:term_white, s:term_grey ], [ '#729fcf', '#303540', s:term_blue, s:term_black ] ]
...
let s:p.visual.right = [ [ '#303540', '#fabd2f', s:term_black, s:term_purple, 'bold' ], s:p.normal.right[1], [ '#c678dd', '#303540', s:term_purple, s:term_black ] ]
